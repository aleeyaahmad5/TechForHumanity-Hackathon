...
| Tier | Cash | Benefits |
|---|---|---|
| **Platinum** | $5,000+ | Logo on all materials (top placement), speaking slot, 2 judges + 2 mentors, demo day booth, first right of refusal on next year's Platinum slot |
| **Gold** | $2,000–$4,999 | Logo on materials, prize contribution, 1–2 mentors |
| **Silver** | $500–$1,999 | Logo on materials, prize or volunteer support |
| **In-kind** | — | Catering, AV equipment, prizes, or mentor/judge time — no cash, tracked as an expense offset in [05_Budget_Revenue](05_Budget_Revenue.md) |

## Outreach Timeline (maps to [03_Project_Plan_WBS](03_Project_Plan_WBS.md) §3)
...
|---|---|---|---|---|
| TI MedTech | Anchor/Primary | Platinum-equivalent (scope TBD) | K, A, Dr Irwan/Tita | Pending scope call — [01](01_TI_MedTech_Partnership_Clarification.md) |
| IBM (Leon's connection) | Enterprise | Gold/Platinum | Leon | Not yet contacted |
...
## Draft Sponsor Agreement Checklist

- [ ] Logo usage rights & exact placement (landing page, signage, slide deck, social)
- [ ] Speaking/judging commitments (who, when, how long)
- [ ] Mentorship participation (how many people, which time blocks)
- [ ] Prize contributions, if any (cash or in-kind, and what category)
- [ ] Social media tag & credit (which handles, what cadence)
- [ ] Post-event reporting commitment (what TI MedTech/each sponsor receives — see [12_Evaluation_PostEvent](12_Evaluation_PostEvent.md))
- [ ] Payment terms (due date — recommend 2 weeks before event, per risk register)

## TI MedTech — Why Primary Sponsor Makes Sense

- **Brand visibility:** direct access to ~50–80 Melbourne students plus Singapore attendees, in a "social impact tech" context that aligns with TI MedTech's own positioning.
...
- **Expected return:** a participant network, brand awareness among the next generation of health-tech talent, and a mentorship pipeline that costs far less than a standalone recruiting event.
...
See [TEMPLATES/Sponsor_Email_Template.md](TEMPLATES/Sponsor_Email_Template.md).
