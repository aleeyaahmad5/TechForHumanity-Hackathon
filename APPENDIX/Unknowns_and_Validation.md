...
| 4 | **RMIT venue and AV are genuinely $0 cost** — the whole low-budget model depends on this holding (see [05_Budget_Revenue](../05_Budget_Revenue.md)) | Critical | Leon (via RMIT Activator) | Confirm no room fee, no AV rental fee, before the budget is treated as final | Week 2–3 |
