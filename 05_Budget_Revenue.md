...
| **Catering (2 lunches, Catering At Its Finest grazing boxes)** | **≤ $1,200 at full 150-head capacity** | See breakdown below — the only real spend in this budget, scales down at lower attendance |
| Contingency (10% of catering only) | ≤ $120 at ceiling | |
| **Total (at 150-head ceiling)** | **≤ $1,320** | Scales down proportionally at lower attendance |
...
- Rough rate: ~$8/head across the 2 lunches (10 people/box × ~$40/box ≈ $4/head/lunch × 2 lunches).
- At the 150-head ceiling: ~15 boxes per lunch × 2 lunches ≈ 30 boxes. At ~$40/box average: 30 × $40 = **$1,200**.
...
Catering scales with total headcount (participants + mentors/judges/volunteers), so more attendance is good for the budget, not risky. Ticket revenue is calculated on the paying-participant share of each scenario's total headcount.

| Total heads | Paid tickets (~90% of participants) | Ticket revenue (@ $27 avg) | Catering + contingency | Profit to Kashaf & Aleeya |
|---|---|---|---|---|
