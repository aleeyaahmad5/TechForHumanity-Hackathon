...
```
Volunteer/tech issue          → tell nearest volunteer
Participant safety/health     → tell Participant Experience Lead
Major problem (AV, catering,
  room issue)                 → tell Kashaf or Aleeya
Life-threatening emergency    → call 000 (Australia); inform Kashaf immediately
...
See [04_Schedule.json](04_Schedule.json) → `onTheDayCriticalPath.melbourne` for the machine-readable version of this same timeline.
