# Social Media Posts — Volunteer & Mentor Recruitment

Companion to [10_Social_Copy.txt](../10_Social_Copy.txt), which covers participant-facing marketing. These are for staffing the event itself.

## Volunteer Recruitment — Poster (university clubs)
...
Get behind-the-scenes hackathon experience, meet industry mentors,
free food both days.
...
## Mentor/Judge Recruitment — LinkedIn Post
...
Comment or DM to get involved.
```

Sign-up form fields for volunteers: [Volunteer_SignUp_Form_Fields.csv](Volunteer_SignUp_Form_Fields.csv).
