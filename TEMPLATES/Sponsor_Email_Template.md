...
- **Silver ($500–$1,999):** logo placement, prize or volunteer support
- **In-kind:** catering, AV, prizes, or mentor/judge time — no cash required

Would you be open to a 15-minute call this week to talk through what would make the most sense for [Company]?

Thanks,
[Name]
[Role, TI MedTech / RMIT Activator]
[Contact info]

---

**Follow-up (no response after 5 business days):**

Hi [Name], following up on the note below — happy to send a one-page sponsor deck if that's easier than a call. Let me know what works.
